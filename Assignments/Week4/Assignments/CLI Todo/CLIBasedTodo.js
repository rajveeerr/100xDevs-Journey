...
function fileContents(filename) {
    try {
        ...
        console.log(chalk.red("Error Status: " + err));
        return -1
    }
}
...
function writefileContents(filename, data) {
    try {
        ...
        console.log(chalk.red("There was an internal error updating your ToDos Data. Make sure you haven't deleted/moved CLIToDo.json file"));
        console.log(chalk.red("Error Status: " + err));
        return -1
    }
}
...
program.command('add')
    ...
    .action((str, options) => {
        ...
        try {
            ...
            dueDate = null;
            console.log(chalk.yellow("\nDue Date is set to null as you've entered it in incorrect format. Try this format yyyy-mm-dd day and month must be of two digit and year must be of 4, like: 2024-08-06"));
        }
