...
export default function App() {
  ...
  // with const keyword, we can change the value of the variable but not the variable itself, that means that the counter value 
  // can be changed, to anything but the length of array cannot be changed

  function incCounter(){
    setCounter(counter+1)//this will trigger re-render
  }

  function addTodo() {//can we pass arguments to this function while calling this onClick from button??, yes, just call this fn with args using anonymus function and put the args in the anon fn call
    let newTodos=[]
    ...
    //minimal way of doing the same as above, [...todos,task], is basically creating new array with all teh elements of the
    //  todos array and adding the task at the end of the array
  }
