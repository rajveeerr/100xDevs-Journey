export default function Input({refVar,placeholder,type,onChange,min,max,onBlur,required,defaultValue}){
    ...
    return <>
    <input ref={refVar} type={type} defaultValue={defaultValue} onChange={onChange} onBlur={onBlur} placeholder={placeholder} min={min} required={required} max={max}  className='text-base px-3 py-3 w-full rounded-xl bg-gradient-to-b border-2
