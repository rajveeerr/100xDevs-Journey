...
export default function AgeVerification(){
    ...
    let checkValidity=(e)=>{
      ...
      if(e.target.value&&valid){ data.current.age=e.target.value;
       }
    }
    ...
    return <div className='pt-12 flex flex-col md:items-center md:text-center'>
        ...
        <div className='mt-6 w-full max-w-80'>
            <Input placeholder="Enter your year of birth" type="number" defaultValue={data.current.age} max={2024} min={1950} onBlur={checkValidity} onChange={checkValidity} required={true}/>
        </div>
